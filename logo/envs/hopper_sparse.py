...
https://github.com/fiberleif/sparse-gym-mujoco/blob/master/sparse_gym_mujoco/envs/sparse_hopper.py
https://github.com/bmazoure/sparseMuJoCo

'''

class SparseHopperEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,saprse_val = 2.):
